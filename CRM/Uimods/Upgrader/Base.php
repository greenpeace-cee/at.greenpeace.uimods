 ...
 */
class CRM_Uimods_Upgrader_Base {

  /**
   * @var CRM_Uimods_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      self::$instance = new CRM_Uimods_Upgrader(
        'at.greenpeace.uimods',
        E::path()
      );
    }
   ...
   *
   * ```
   * CRM_Uimods_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_Uimods_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
